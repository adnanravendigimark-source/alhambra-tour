    ...
    <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <SectionCard title="Open Graph &amp; Twitter/X Preview" description="Used when the homepage is shared on Facebook, WhatsApp, iMessage, Twitter/X, etc. Leave blank to fall back to the hero's own title/description/image.">
            ...
            <div className="overflow-hidden rounded-xl border border-stone-200">
              ...
              <div className="bg-stone-50 p-3">
                <p className="truncate text-xs uppercase tracking-wide text-stone-400">granadaalhambratour.com</p>
      ...
      {activeTab === "images" && (
        <div className="space-y-5">
          ...
          <SectionCard title="Hero photo" description="Shown as the full-bleed background photo behind the hero heading, and used for social share previews.">
