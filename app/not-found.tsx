...
export default async function NotFound() {
  ...
  return (
    <>
      <Header />
      <main className="mx-auto flex min-h-[60vh] max-w-2xl flex-col items-center justify-center px-4 pt-24 pb-20 text-center sm:px-6 sm:pt-28 lg:pt-32">
        <p className="font-display text-7xl font-black text-[#0F5C56]">404</p>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          <Link
            ...
            className="rounded-xl bg-[#0F5C56] hover:bg-[#0B4640] px-6 py-3 text-sm font-bold text-white shadow-md transition hover:scale-[1.02]"
          >
            {s.primaryButtonText}
          </Link>
          <Link
